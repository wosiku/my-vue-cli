...
//       l: o, z: n(i, 'zIndex', -1), o: n(i, 'opacity', 0.5), c: n(i, 'color', '0,0,0'), n: n(i, 'count', 99)
...
//         t = (n.max - l) / n.max, r.beginPath(), r.lineWidth = t / 2, r.strokeStyle = 'rgba(' + d.c + ',' + (t + 0.2) + ')', r.moveTo(i.x, i.y), r.lineTo(n.x, n.y), r.stroke()));
//       }
//     });
